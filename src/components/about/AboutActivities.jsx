                                            ...
                                            >
                                                <li className="nav-item" role="presentation">
                                                    ...
                                                    >
                                                        ...
                                                        <h6>Popular events in Dubai and worldwide</h6>
                                                    </div>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <div
                                        ...
                                        <div className="tab-content" id="pills-tab3Content">
                                            ...
                                            >
                                                <div className="tab-content-wrap">
                                                    <h2>Popular events in Dubai and worldwide</h2>
                                                    <p>
                                                    Step into another world of creating unforgettable memories of lifetime with our premium event services. Let us turn your desires of being part of most happening events in the UAE into reality, ensuring every detail is perfect.
                                            ...
                                            >
                                                <div className=" tab-content-wrap">
                                                    ...
                                                    <p>
                                                    Dive into the heart of the desert. Feel the kick as you descend across the dunes, bouncing and sliding in a thrilling dune bash. Experience the ultimate adventure, where adrenaline and awe collide beneath the endless desert sky.
                                            ...
                                            >
                                                <div className=" tab-content-wrap">
                                                    <h2>Hot Air Balloon in UAE:</h2>
                                                    <p>
                                                    Soar high above the golden sands in a hot air balloon, where the UAE’s enticing desert landscape unfolds beneath you. Glide smoothly across the sky as the early morning and sun casts a magical glow over the sand dunes. 
                                            ...
                                            >
                                                <div className=" tab-content-wrap">
                                                    ...
                                                    <p>
                                                    Live out the thrill of skiing in the heart of the desert at Ski Dubai. Plunge down cool snow slopes, surrounded by tempting indoor alpine settings, where the winter fun meets the warmth of the desert. Embrace the adventure of skiing in the deserts.
                                                    </p>
                                                    <ul>
                                                        {/* <li>
                                                            <svg
                                            ...
                                            >
                                                <div className=" tab-content-wrap">
                                                    ...
                                                    <p>
                                                    Embark on a transformative Umrah journey with ATS. From fast-tracked visa processing to luxurious accommodations and expert guidance, we ensure your pilgrimage is smooth, hassle-free, and enriching. We strive to make your Umrah truly spiritual.
                                                    </p>
                                                    <ul>
                                                        {/* <li>
                                                            <svg
