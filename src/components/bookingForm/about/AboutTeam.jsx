...
const AboutTeam = () => {
    ...
    return (
        <>
            <div className="teams-section mb-120 about-team">
                                    ...
                                    <div className="swiper-wrapper">
                                        <SwiperSlide className="swiper-slide">
                                            <div className="teams-card">
                                                ...
                                                <div className="teams-img">
                                                    <img
                                                        src="/assets/img/home2/teams-img.png"
                                                        alt=""
                                                    />
                                                </div>
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="teams-card">
                                                ...
                                                <div className="teams-img">
                                                    <img
                                                        src="/assets/img/home2/teams-img-two.png"
                                                        alt=""
                                                    />
                                                </div>
                                                <div className="teams-content">
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="teams-card">
                                                ...
                                                <div className="teams-img">
                                                    <img
                                                        src="/assets/img/home2/teams-img-three.png"
                                                        alt=""
                                                    />
                                                </div>
                                                <div className="teams-content">
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="teams-card">
                                                ...
                                                <div className="teams-img">
                                                    <img
                                                        src="/assets/img/home2/teams-img-four.png"
                                                        alt=""
                                                    />
                                                </div>
                                                <div className="teams-content">
